...
public class EditorFactoryImpl extends EFactoryImpl implements EditorFactory {
	...
	public static EditorFactory init() {
		try {
			EditorFactory theEditorFactory = (EditorFactory)EPackage.Registry.INSTANCE.getEFactory("http://no2.zehrer.net/editor/1.0"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case EditorPackage.COMPOSITE_NODE: return createCompositeNode();
			case EditorPackage.LEAF_NODE: return createLeafNode();
			case EditorPackage.SYNTAX_ERROR: return createSyntaxError();
			default:
