 ...
 * </copyright>
 *
 * $Id: CreateObjctAction.java,v 1.5 2007/09/30 10:31:29 emerks Exp $
 */
 ...
 * CreateChildCommand}.
 */
public class CreateObjctAction extends StaticSelectionCommandAction
{
  /**
   ...
   * @since 2.1.0
   */
  public CreateObjctAction(IWorkbenchPart workbenchPart, ISelection selection, Object descriptor)
  {
    super(workbenchPart);
   ...
   * calls the {@link #CreateObjctAction(IWorkbenchPart, ISelection, Object)
   * new form}.
   */
  public CreateObjctAction(IEditorPart editorPart, ISelection selection, Object descriptor)
  {
   ...
   * @since 2.4.0
   */
  public CreateObjctAction(EditingDomain editingDomain, ISelection selection, Object descriptor)
  {
    super(editingDomain);
    this.descriptor = descriptor;
    configureAction(selection);
