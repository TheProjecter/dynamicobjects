...
//	protected ISelectionProvider selectionProvider;
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(NO2EditorPlugin.INSTANCE.getString("_UI_ModelEditor_menu"), "net.zehrer.no2.modelMenuID");
		...
		//
		createChildMenuManager = new MenuManager(NO2EditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(NO2EditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void setActiveEditor(IEditorPart part) {
		...
		if (part == null) {
			...
			IWorkbenchPage newPage = part.getSite().getPage();
			// analyse if page has changed
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(NO2EditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(NO2EditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
