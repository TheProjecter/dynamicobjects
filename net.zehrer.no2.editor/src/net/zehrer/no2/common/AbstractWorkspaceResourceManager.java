...
import net.zehrer.no2.editor.ResourceDeltaVisitor;
...
public abstract class AbstractWorkspaceResourceManager extends WorkspaceModifyOperation implements IResourceChangeListener{
 
	private IEMFResourceEditor editor;
	...
	public AbstractWorkspaceResourceManager() {
		super();
	}
	...
	/**
	 * @category IResourceChangeListener
	 */
	...
	protected void setEditor (IEMFResourceEditor editor) {
		this.editor = editor;
	}
	
	public IEMFResourceEditor getEditor() {
		return this.editor;
	}
