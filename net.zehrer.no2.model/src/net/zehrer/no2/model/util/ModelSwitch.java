...
public class ModelSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.NO2_MODEL: {
				NO2Model no2Model = (NO2Model)theEObject;
				T result = caseNO2Model(no2Model);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>NO2 Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>NO2 Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNO2Model(NO2Model object) {
		return null;
	}
