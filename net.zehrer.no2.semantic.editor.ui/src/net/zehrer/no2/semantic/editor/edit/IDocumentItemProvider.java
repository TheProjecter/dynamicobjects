...
public class IDocumentItemProvider extends ItemProviderAdapter implements IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IEditingDomainItemProvider {
	...
	public IDocumentItemProvider(AdapterFactory adapterFactory) {
