...
/**
 * This is the item provider adapter 
 */
public class MetaModelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
		IItemPropertySource {
	/**
...
//
		return null;
//		Map labelValue = ((E) object).getResourceMap();
